...
const navItems = [
  ...
  { icon: 'group',  label: 'Pending Users', path: '/hr/pending-users' },
...
export default function HRLayout({ user }) {
    ...
    <div style={styles.page}>
      <aside style={styles.sidebar}>
        ...
        <nav style={styles.nav}>
          ...
          {navItems.map((item) => {
            const isNotif = item.path === '/hr/notifications';
        ...
        <div style={styles.sidebarFooter}>
          ...
          <div style={styles.userChip}>
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              <div style={styles.userRole}>HR Specialist</div>
            </div>
          </div>
